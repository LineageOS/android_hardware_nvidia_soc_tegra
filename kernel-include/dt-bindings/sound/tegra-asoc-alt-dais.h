...
// Upstream names mapped to original downstream dais
#define XBAR_MIXER_IN1		XBAR_MIXER_IF1
#define XBAR_MIXER_IN2		XBAR_MIXER_IF2
#define XBAR_MIXER_IN3		XBAR_MIXER_IF3
#define XBAR_MIXER_IN4		XBAR_MIXER_IF4
#define XBAR_MIXER_IN5		XBAR_MIXER_IF5
#define XBAR_MIXER_IN6		XBAR_MIXER_IF6
#define XBAR_MIXER_IN7		XBAR_MIXER_IF7
#define XBAR_MIXER_IN8		XBAR_MIXER_IF8
#define XBAR_MIXER_IN9		XBAR_MIXER_IF9
#define XBAR_MIXER_IN10		XBAR_MIXER_IF10
#define XBAR_MIXER_OUT1		XBAR_MIXER_IF1
#define XBAR_MIXER_OUT2		XBAR_MIXER_IF2
#define XBAR_MIXER_OUT3		XBAR_MIXER_IF3
#define XBAR_MIXER_OUT4		XBAR_MIXER_IF4
#define XBAR_MIXER_OUT5		XBAR_MIXER_IF5
#define XBAR_MIXER_OUT6		XBAR_MIXER_IF6
#define XBAR_MIXER_OUT7		XBAR_MIXER_IF7
#define XBAR_MIXER_OUT8		XBAR_MIXER_IF8
#define XBAR_MIXER_OUT9		XBAR_MIXER_IF9
#define XBAR_MIXER_OUT10	XBAR_MIXER_IF10
#define XBAR_SFC1_RX		XBAR_SFC1
#define XBAR_SFC2_RX		XBAR_SFC2
#define XBAR_SFC3_RX		XBAR_SFC3
#define XBAR_SFC4_RX		XBAR_SFC4
#define XBAR_SFC1_TX		XBAR_SFC1
#define XBAR_SFC2_TX		XBAR_SFC2
#define XBAR_SFC3_TX		XBAR_SFC3
#define XBAR_SFC4_TX		XBAR_SFC4
#define XBAR_MVC1_RX		XBAR_MVC1
#define XBAR_MVC2_RX		XBAR_MVC2
#define XBAR_MVC1_TX		XBAR_MVC1
#define XBAR_MVC2_TX		XBAR_MVC2
#define XBAR_OPE1_RX		XBAR_OPE1
#define XBAR_OPE2_RX		XBAR_OPE2
#define XBAR_OPE1_TX		XBAR_OPE1
#define XBAR_OPE2_TX		XBAR_OPE2
#define XBAR_ASRC_IN1		XBAR_ASRC_IF1
#define XBAR_ASRC_IN2		XBAR_ASRC_IF2
#define XBAR_ASRC_IN3		XBAR_ASRC_IF3
#define XBAR_ASRC_IN4		XBAR_ASRC_IF4
#define XBAR_ASRC_IN5		XBAR_ASRC_IF5
#define XBAR_ASRC_IN6		XBAR_ASRC_IF6
#define XBAR_ASRC_IN7		XBAR_ASRC_IF7
#define XBAR_ASRC_OUT1		XBAR_ASRC_IF1
#define XBAR_ASRC_OUT2		XBAR_ASRC_IF2
#define XBAR_ASRC_OUT3		XBAR_ASRC_IF3
#define XBAR_ASRC_OUT4		XBAR_ASRC_IF4
#define XBAR_ASRC_OUT5		XBAR_ASRC_IF5
#define XBAR_ASRC_OUT6		XBAR_ASRC_IF6
#define XBAR_ASRC_OUT7		XBAR_ASRC_IF7
